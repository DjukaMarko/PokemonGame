...
export default function Deck2({ deck_2, setDeck1, setDeck2, resetStack, setSelectedPokemon }) {
    ...
    return (
        <div onDragOver={(e) => e.preventDefault()} 
            ...
            <div className="min-w-36 min-h-40 flex justify-center space-x-2">
                {deck_2.length > 0 && (
                    deck_2.map((pokemon) => (
                        <Card data={[pokemon]} parentId="deck2" setSelectedPokemon={setSelectedPokemon} />
                    ))
                )}
            </div>
        </div>
